...
darwin:
	CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o bin/srun-darwin ./cmd/srun

linux:
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/srun-amd64 ./cmd/srun
...
.PHONY:publish darwin linux armv7 arm64 windows clean
